...
SECRET_KEY = 'django-insecure-s(t9o4-rz(i&1tx9^o(&h&do697ou(e_y30@!0#$3)3-d12t46'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], # IMPORTANTE LA CARPETA TEMPLATES
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Muy IMPORTANTE para archivos estaticos
STATIC_URL = '/static/'
# Add these new lines
STATICFILES_DIRS = (
